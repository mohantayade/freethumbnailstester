...
<>
  ...
  <ul>
    ...
    <li>
      <p>
        ...
        "Us" or "Our" in this Agreement) refers to Free Thumbnails Tester.
      </p>
    </li>
    <li>
      <p>
    ...
    <li>
      <p>
        <strong>Website</strong> refers to Free Thumbnails Tester, accessible
        from{" "}
        <a
          href="www.freethumbnailstester.com"
          rel="external nofollow noopener"
          target="_blank"
        >
          www.freethumbnailstester.com
        </a>
      </p>
    </li>
    <li>
  ...
  <h2 className='text-lg font-medium'>Acknowledgment</h2>
  <p>
  ...
  <h2 className='text-lg font-medium'>Links to Other Websites</h2>
  <p>
  ...
  <h2 className='text-lg font-medium'>Disputes Resolution</h2>
  <p>
  ...
  <h2 className='text-lg font-medium'>For European Union (EU) Users</h2>
  <p>
    If You are a European Union consumer, you will benefit from any mandatory
    provisions of the law of the country in which You are resident.
  </p>
  <h2 className='text-lg font-medium'>United States Legal Compliance</h2>
  <p>
  ...
  <h2 className='text-lg font-medium'>Severability and Waiver</h2>
  <h3 className='text-lg font-medium'>Severability</h3>
  <p>
  ...
  <h3 className='text-lg font-medium'>Waiver</h3>
  <p>
  ...
  <h2 className='text-lg font-medium'>Translation Interpretation</h2>
  <p>
    These Terms and Conditions may have been translated if We have made them
    available to You on our Service. You agree that the original English text
    shall prevail in the case of a dispute.
  </p>
  <h2 className='text-lg font-medium'>Changes to These Terms and Conditions</h2>
  <p>
  ...
  <ul>
    <li>By email: mohanpixles@gmail.com</li>
  </ul>
</>
