...
export const metadata: Metadata = {
  title:"Privacy Policy | freethumbnailstester",
...
function privacy() {
  return (
    <div className="max-w-[1000px] mx-auto p-5">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Free Thumbnails Tester.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Free Thumbnails Tester,
            accessible from{" "}
            <a
      ...
      <h4 className="text-lg font-medium">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <h3 className="text-lg font-medium">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-lg font-medium">Disclosure of Your Personal Data</h3>
      ...
      <ul>
        <li>By email: mohanpixels@gamil.com</li>
      </ul>
    </div>
  );
}
